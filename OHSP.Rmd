...
```{r}
knitr::include_graphics('fig/media/forestry_accord.png')
```
...
absence of longer than 6 weeks. Template to be filled out is attached as
...
They are included in this plan as [Appendix 2 - Tailboard Template].
...
included in [Appendix 3 - First Aid Requirements].
