...
Our tailboard template is unique in that it contains places for documentation of numerous safety policy actions in one place.  Included on the forms are:

    * list here all the components in the same order as the brief subsections below
