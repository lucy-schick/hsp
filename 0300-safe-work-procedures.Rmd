...
-   Ensure you have all the required vehicle safety equipment which can be found [here](https://github.com/NewGraphEnvironment/new_graphiti/blob/main/assets/data/equipment.csv).
...
-   Drive safely and drive to the existing road conditions. Lower speed
    ...
    -   Visibility reduced by dust, fog, rain, snow, sun glare, or condensation;
...
## Unmaned Aerial Vehicles (UAVs) {#uav .Style1}

TODO: see https://github.com/NewGraphEnvironment/hsp/issues/54
...
- All crew members involved in UAV operations must have the proper training and certifications as required by Transport Canada.
...
- Avoid UAV operations during peak air traffic periods, such as the start or end of the workday, unless unavoidable. Assess local air traffic patterns to minimize conflicts.
